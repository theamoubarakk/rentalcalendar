...
# ==============================================================================
# LEFT COLUMN: Calendar, Delete, and Download Sections (unchanged)
# ==============================================================================
with left_col:
...
# ==============================================================================
# RIGHT COLUMN: New Rental Entry
# ==============================================================================
with right_col:
    st.markdown("### 📌 New Rental Entry")

    # 1) Mascot selector OUTSIDE the form for immediate reactivity
    mascot_choice = st.selectbox(
        "Select a mascot:",
        sorted(inventory_df["Mascot_Name"].unique())
    )

    # 2) Show Mascot Details immediately when mascot_choice changes
    ...
    # 3) Now the form for entering a booking
    with st.form("rental_form"):
        # Customer & Phone side-by-side
    ...
    # 4) Handle submission (outside the form block)
    if submitted:
